...
veri=veri.dropna(axis="rows", how="any")
...
X_valid=np.array(X_valid).reshape(X_valid.shape[0],30,1)
...
#Modelin derlenmesi
model.compile(loss="binary_crossentropy",optimizer="adam",metrics=["accuracy",f1_m,precision_m,recall_m, tf.metrics.AUC(name="auc")])
